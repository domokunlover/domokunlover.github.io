/*
    ...
    (But change the script src URL to wherever you have this widget stored on your site!)
        ...
        <div id="c_widget"></div>
        <script src="/assets/js/ayano-comment-widget/comment-widget.js"></script>
...
const s_stylePath = '/assets/js/ayano-comment-widget/comment-widget-dark.css';
const s_formId = '1FAIpQLScvCr2fdHVRx9BL-v8SRl-KntrFs4Objlg-iO0rALm0Uadzaw';
const s_nameId = '1781337003';
const s_websiteId = '966714321';
const s_textId = '1298565983';
const s_pageId = '2097108028';
const s_replyId = '277964264';
const s_sheetId = '1EsnPCbsBTvYzutmsF3U8DqMniLakoqrbb3T-YZle61g';
...
const s_websiteFieldLabel = 'Website (Optional but encouraged!)';
const s_textFieldLabel = '';
const s_submitButtonLabel = 'Send';
const s_loadingText = 'Loading comments...';
const s_noCommentsText = 'Be the first to comment!';
...
const v_formHtml = `
    ...
    <div id="c_nameWrapper" class="c-inputWrapper">
        ...
        <input onmouseover="mechanical.playclip()" class="c-input c-nameInput" name="entry.${s_nameId}" id="entry.${s_nameId}" type="text" maxlength="${s_maxLengthName}" required>
    </div>
    ...
    <div id="c_websiteWrapper" class="c-inputWrapper">
        ...
        <input onmouseover="mechanical.playclip()" class="c-input c-websiteInput" name="entry.${s_websiteId}" id="entry.${s_websiteId}" type="url" pattern="https://.*">
    </div>

    <div id="c_textWrapper" class="c-inputWrapper">
        <label class="c-label c-textLabel" for="entry.${s_textId}">${s_textFieldLabel}</label>
        <textarea onmouseover="mechanical.playclip()" class="c-input c-textInput" name="entry.${s_textId}" id="entry.${s_textId}" rows="4" cols="50"  maxlength="${s_maxLength}" required></textarea>
    </div>

    <input onmouseover="mechanical.playclip()" onclick="flashlight.playclip()" id="c_submitButton" name="c_submitButton" type="submit" value="${s_submitButtonLabel}" disabled>
`;
...
function displayComments(comments) {
    ...
    for (i = 0; i < comments.length; i++) {
        ...
        button.setAttribute('onmouseover', 'mechanical.playclip()');
        button.addEventListener('click', () => flashlight.playclip());
